              ...
              <div class="col-md-8 col-md-offset-2">
                <div class="home-content">
                  <div class="home-heading">
                    <h1><em>Entrena</em>acompañado</h1>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="home-box-content">
                        <div class="left-text">
                          <h4>Haz <em>Ejercicio</em> con amigos</h4>
                          <p>En WHPH tenemos un compromiso con nuestros clientes. Mientras más amigos invites, más entretenido y barato será entrenar.</p>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="about-box-content">
                          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/about-image.png" alt="">
                      </div>
                    </div>
                      ...
                      <div class="owl-carousel owl-theme projects-container">
                        <div>
                          <div class="price-item">
                            <a href="/assets/img/price-item-01.jpg" data-lightbox="image-1"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/price-item-01.jpg" alt=""></a>
                        ...
                        <div>
                          <div class="price-item">
                            <a href="/assets/img/price-item-02.jpg" data-lightbox="image-1"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/price-item-02.jpg" alt=""></a>
                            <div class="text-content">
                              <h4>Boxeo</h4>
                        ...
                        <div>
                          <div class="price-item">
                            <a href="/assets/img/price-item-03.jpg" data-lightbox="image-1"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/price-item-03.jpg" alt=""></a>
                            <div class="text-content">
                              <h4>Crossfit</h4>
                        ...
                        <div>
                          <div class="price-item">
                            <a href="/assets/img/price-item-04.jpg" data-lightbox="image-1"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/price-item-04.jpg" alt=""></a>
                            <div class="text-content">
                              <h4>JIU-JITSU</h4>
                        ...
                        <div>
                          <div class="price-item">
                            <a href="/assets/img/price-item-05.jpg" data-lightbox="image-1"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/price-item-05.jpg" alt=""></a>
                            <div class="text-content">
                              <h4>Fitbox</h4>
                        ...
                        <div>
                          <div class="price-item">
                            <a href="/assets/img/price-item-06.jpg" data-lightbox="image-1"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/price-item-06.jpg" alt=""></a>
                            <div class="text-content">
                              <h4>Zumba</h4>
                        ...
                        <div>
                          <div class="price-item">
                            <a href="/assets/img/price-item-07.jpg" data-lightbox="image-1"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/price-item-07.jpg" alt=""></a>
                            <div class="text-content">
                              <h4>Baby Fútbol</h4>
